// Code generated by the Encore v1.46.17 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-backend-2tui.encr.app`
}
...
/**
 * Client is an API client for the backend-2tui Encore application.
 */
export default class Client {
    public readonly admin: admin.ServiceClient
    public readonly basket: basket.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.basket = new basket.ServiceClient(base)
...
export namespace admin {
    ...
    export class ServiceClient {
        ...
        public async getHelloWorld(): Promise<DashboardData> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "backend-2tui-Generated-TS-Client (Encore/v1.46.17)";
        }
